...
const { getPGs, getPGById, createPG, updatePG, deletePG, getMyPGs, aiSearch, getSuggestions, getMyUpdateRequests, cancelUpdateRequest } = require('../../controllers/pg.controller');
